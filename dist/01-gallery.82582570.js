...
const elementsFromGallery = createElementsFromGallery(_galleryItems.galleryItems);
galleryContainer.insertAdjacentHTML('afterbegin', elementsFromGallery);
console.log(createElementsFromGallery(_galleryItems.galleryItems));

function createElementsFromGallery(obj) {
  return _galleryItems.galleryItems.map(({
    preview,
    original,
    description
  }) => {
